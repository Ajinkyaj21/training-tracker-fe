...
// import GetActivite from "../../samplePayload/index";
// import {
...
// 					</div>
// 					<div className={TrainingStyles.selectBox}></div>
...
// 				<div className={TrainingStyles.editDiv}>
...
// 							<th style={{ width: "100px" }}>Sub Topic</th>
// 							<th style={{ width: "100px" }}>Start Date </th>
// 							<th style={{ width: "100px" }}>Due Date </th>
// 							<th style={{ width: "100px" }}>End Date </th>
// 							<th style={{ width: "100px" }}> Resource Link </th>
...
// 					</thead>
// 					<tbody
// 						className={TrainingStyles.scrollable_body}
// 						style={{ maxHeight: "300px", overflowY: "auto" }}
// 					>
// 						{
// 							GetActivite.map( (items) => (
// 								<tr
// 									key={items.topicId}

// 									style={{ cursor: "pointer", textAlign: "center" }}
// 								>
// 									<td>{items.techonology}</td>
// 									<td>{items.activityName}</td>
// 									<td>{items.topic}</td>
// 									<td>{items.subTopic}</td>
...
// 									<td>
// 										<button onClick={() => navigate(`/edit/${items.topicId}`)}>Edit</button>
// 										{/* <Link to={`/edit/${items.topicId}`}> Edit </Link> */}
// 									</td>
...
// 				</table>
// 				<ReactPaginate
// 					pageCount={Math.ceil(GetActivite.length / itemsPerPage)}
